...
Config.Lockpick = {
    ...
    IgnitionTime = {Min = 45, Max = 55}, --RANDOM AMOUNT OF TIME (SECONDS) TO ATTEMPT LOCKPICKING A VEHICLE DOOR WITH A REGULAR LOCKPICK. ADVANCED PICK WILL BE HALF OF THIS VALUE
    IgnitionFailChance = 1, --NUMBER 0-100. LOWER NUMBER = LESS CHANCE TO FAIL THE ATTEMPT. 0 = NEVER FAIL. 100 = ALWAYS FAIL.
    IgnitionBreakPick = {
        OnSuccess = {
...
Config.HotwireFailChance = 1 --Number 0-100. Lower the number less chance to fail. 0 = will never fail. 100 = will always fail. [DOES NOT APPLY IF USING MINIGAME BELOW]
...
Config.KeysAsItem = {
    PlayerOwned = {
        ...
        ItemName = 'carkey',
        CanHotwire = true, --TRUE = CAN HOTWIRE PLAYER OWNED VEHICLES / FALSE = CANNOT HOTWIRE PLAYER OWNED VEHICLES
        CanLockpickDoor = true, --TRUE = CAN LOCKPICK PLAYER OWNED VEHICLE DOORS / FALSE = CANNOT LOCKPICK PLAYER OWNED VEHICLE DOORS
        CanLockpickIgnition = true, --TRUE = CAN LOCKPICK PLAYER OWNED VEHICLE IGNITIONS / FALSE = CANNOT LOCKPICK PLAYER OWNED VEHICLE IGNITIONS
        ...
        GiveWhitelistJobKeys = true, --TRUE = IF VEHICLE MODEL IS LISTED IN CONFIG.JOBWHITELISTEDVEHICLES ANY PLAYER WITH THAT WHITELISTED JOB WILL GET A SET OF KEYS (NOT FOB) WHEN THEY SIT IN THE DRIVER SEAT OR TOGGLE VEHICLE LOCKS. / FALSE = MUST HAVE FOB EVEN IF YOU HAVE THE WHITELISTED JOB
    },
    KeyManagement = {
...
Config.DisableAccelerateVehicleStart = false --TRUE = ENGINE WILL NOT START WHEN YOU ACCELERATE IF YOU HAVE KEYS / FALSE = ENGINE STARTS WHEN YOU PRESS ACCELERATE KEY IF YOU HAVE KEYS TO THE VEHICLE
------------------------------------------------------------------------------------------------------------------------------
