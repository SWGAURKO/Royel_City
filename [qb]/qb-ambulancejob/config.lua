...
Config.Locations = { -- Edit the various interaction points for players or create new ones
    ["checking"] = {
	    [1] = vector3(302.28, -589.64, 43.27),
	    [2] = vector3(-254.54, 6331.78, 32.43), -- paleto
    },
    ["duty"] = {
        [1] = vector3(311.70, -569.08, 43.27),
        [2] = vector3(-254.88, 6324.5, 32.58),
    },
    ["vehicle"] = {
        [1] = vector4(342.28, -559.95, 28.74, 344.86),
        [2] = vector4(-234.28, 6329.16, 32.15, 222.5),
    },
    ["helicopter"] = {
        [1] = vector4(352.82, -587.89, 74.16, 87.34),
        [2] = vector4(-475.43, 5988.353, 31.716, 31.34),
    },
    ["armory"] = {
        [1] = vector3(326.42, -583.44, 43.27),
        [2] = vector3(-245.13, 6315.71, 32.82),
    },
    ["roof"] = {
        [1] = vector4(338.53, -583.77, 74.16, 76.82),
    },
    ["main"] = {
        [1] = vector3(317.33, -575.76, 43.28),
    },
    ["stash"] = {
        [1] = vector3(321.13, -581.49, 43.27),
    },
    ["beds"] = {
        [1] = {coords = vector4(311.72, -586.80, 44.18, 69.82), taken = false, model = 1631638868},
        -- [2] = {coords = vector4(309.20, -577.70, 44.20, 337.67), taken = false, model = 1631638868},
        -- [3] = {coords = vector4(319.35, -581.41, 44.20, 346.80), taken = false, model = 2117668672},
        -- [4] = {coords = vector4(311.12, -583.04, 44.20, 343.28), taken = false, model = 2117668672},
        -- [5] = {coords = vector4(314.53, -584.15, 44.20, 346.58), taken = false, model = 2117668672},
        -- [6] = {coords = vector4(317.72, -585.30, 44.20, 343.56), taken = false, model = -1091386327},
        -- [7] = {coords = vector4(319.38, -581.14, 44.20, 162.08), taken = false, model = -1091386327},
        -- [8] = {coords = vector4(313.85, -579.16, 44.20, 160.73), taken = false, model = -1091386327},
	    --- paleto
	    [2] = {coords = vector4(-252.43, 6312.25, 32.34, 313.48), taken = false, model = 2117668672},
        [3] = {coords = vector4(-247.04, 6317.95, 32.34, 134.64), taken = false, model = 2117668672},
        [4] = {coords = vector4(-255.98, 6315.67, 32.34, 313.91), taken = false, model = 2117668672},
    },
    ["jailbeds"] = {
