...
zr_config.clothing = 'illenium-appearance' -- 'qb-clothing' or 'illenium-appearance' or 'rcore_clothing'
zr_config.spawn = 'zr-locations' --  'ps-housing' or 'qb-spawn' or 'zr-locations'
