...
RegisterNetEvent('qb-mugshot:client:trigger', function()
    ped = PlayerPedId()
    ...
    CreateThread(function()
        ...
        if Config.CQCMDT then
            TriggerServerEvent('qb-mugshot:server:MDTupload', playerData.citizenid, MugshotArray)
        end
...
RegisterNetEvent("qb-mugshot:client:takemugshot",function()
...
if Config.TestCommand then
    ...
    RegisterCommand("testmugshotself", function(source)
        TriggerEvent('qb-mugshot:client:trigger')
    end, false)
end