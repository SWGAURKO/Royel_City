...
Config.TransferVehicle = {
    ENABLE = false, --Do you want to use the built features to transfer vehicles to another player?
...
Config.Locations = {
    {
        ...
        x_1 = 222.606, y_1 = -793.274, z_1 = 30.714, --This is the location of the garage, where you press e to open for example.
...
Config.ImpoundLocations = { --DO NOT CHANGE THE TABLE IDENTIFIERSs, for example - ['car_2'], if you wish to add more, then name the next one ['car_3']. It must have either 'car'/'boat'/'air' in the name and also be unique.
    ...
    ['car_3'] = { 
        ImpoundID = 5,
        coords = {x = -131.27, y = 6282.87, z = 31.35},
        spawnpoint = {x = -131.27, y = 6282.87, z = 31.35, h = 220.89},
        blip = {
            sprite = 357,
            scale = 0.6,
            colour = 3,
            name = L('car_peleto_impound'),
        }
    },
