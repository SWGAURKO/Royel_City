...
Config.OxInventory = true -- if you are using ox inventory please set this true for CanCarryItem
...
Config.Spots = {
...

    {
        ...
        location = "Alamo Sea",
        statement =
        "The Chumash Historic Family Pier is located in the heart of Chumash, which is accessible from Barbareno Road. A staple icon of the area, the boardwalk is lined with white fencing.",
        spotQuality = "Normal",
...

    {
        ...
        location = "Alamo Sea",
        statement =
        "Procopio Beach is a beach in Grand Theft Auto V and Grand Theft Auto Online, located in northern Blaine County, east of Paleto Bay. It is located off the Great Ocean Highway and is located east of the Procopio Promenade.",
        spotQuality = "Good",
        afkCatchInMinute = 4,
    ...
    },
    {
        ...
        location = "Alamo Sea",
        statement =
        "A group of businesses located at a pier on the north shore of the Alamo -Sea at the western edge of the settlement of Galilee, including the boatshop and a related fishing charter/commercial fishery Millars Fishery.",
...

    {
        ...
        location = "Alamo Sea",
        statement =
        "The Alamo Sea is the largest body of water located on the San Andreas mainland. It is fed by agricultural runoff from nearby Grapeseed and drains into the Pacific Ocean via Cassidy Creek and the Zancudo River..",
    ...
    },
    {
        ...
        statement =
        "The center is located on Tongva Drive in Tongva Valley, Los Santos County right next to a stream which eventually feeds into the Zancudo River.",
        spotQuality = "Epic",
        afkCatchInMinute = 5, --min
