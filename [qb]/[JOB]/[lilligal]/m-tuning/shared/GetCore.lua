function GetCore()
    ...
    if Config.Framework == "oldesx" then
        ...
        if not object then
            print("m-tuning:Framework is not selected in the config correctly if you're sure it's correct please check your events to get framework object")
        end
    end
    ...
    if Config.Framework == "QBCore" then
        ...
        if not object then
            ...
            print("m-tuning:Framework object found : ", Framework)
        end
    end
    ...
    if Config.Framework == 'autodetect' then
        ...
        if not object then
            print("m-tuning:Framework object couldn't find. Setting chat to standalone")
