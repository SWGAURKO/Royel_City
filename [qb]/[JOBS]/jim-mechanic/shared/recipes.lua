...
Stores = {
	...
	RepairItems = {
		...
		items = {
			...
			{ name = "axleparts", price = 2000, amount = 1000, info = {}, type = "item", },
	...
	PerformItems = {
		...
		items = {
			...
			{ name = "engine4", price = 18000, amount = 50, info = {}, type = "item", },
			{ name = "engine5", price = 20000, amount = 50, info = {}, type = "item", },
			{ name = "transmission1", price = 10000, amount = 50, info = {}, type = "item", },
			{ name = "transmission2", price = 13000, amount = 50, info = {}, type = "item", },
			...
			{ name = "suspension4", price = 18000, amount = 50, info = {}, type = "item", },
			{ name = "suspension5", price = 20000, amount = 50, info = {}, type = "item", },
		--	{ name = "bprooftires", price = 0, amount = 50, info = {}, type = "item", },
			{ name = "drifttires", price = 15000, amount = 50, info = {}, type = "item", },

			{ name = "oilp1", price = 2000, amount = 50, info = {}, type = "item", },
			{ name = "oilp2", price = 4000, amount = 50, info = {}, type = "item", },
			{ name = "oilp3", price = 8000, amount = 50, info = {}, type = "item", },

			{ name = "drives1", price = 2000, amount = 50, info = {}, type = "item", },
			{ name = "drives2", price = 4000, amount = 50, info = {}, type = "item", },
			{ name = "drives3", price = 8000, amount = 50, info = {}, type = "item", },

			{ name = "cylind1", price = 2000, amount = 50, info = {}, type = "item", },
			{ name = "cylind2", price = 4000, amount = 50, info = {}, type = "item", },
			{ name = "cylind3", price = 8000, amount = 50, info = {}, type = "item", },

			{ name = "cables1", price = 2000, amount = 50, info = {}, type = "item", },
			{ name = "cables2", price = 4000, amount = 50, info = {}, type = "item", },
			{ name = "cables3", price = 8000, amount = 50, info = {}, type = "item", },

			{ name = "fueltank1", price = 2000, amount = 50, info = {}, type = "item", },
			{ name = "fueltank2", price = 4000, amount = 50, info = {}, type = "item", },
			{ name = "fueltank3", price = 8000, amount = 50, info = {}, type = "item", },

			{ name = "harness", price = 2000, amount = 50, info = {}, type = "item", },
			{ name = "antilag", price = 1000, amount = 50, info = {}, type = "item", },

			{ name = "manual", price = 2000, amount = 50, info = {}, type = "item", },
		},
	},
	CosmeticItems = {
		...
		items = {
			...
			{ name = "bumper", price = 4500, amount = 50, info = {}, type = "item", },
			...
			{ name = "tires", price = 8000, amount = 50, info = {}, type = "item", },
			...
			{ name = "underglow", price = 2500, amount = 50, info = {}, type = "item", },
		},
	},
}
