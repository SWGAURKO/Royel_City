...
Config.fish = {
    { item = 'tuna', label = 'Tuna', price = {800, 1500}, difficulty = {'medium', 'easy', 'easy'} }, -- name is the item name of the fish(must be in DB of items) / Price is the range of price it will sell to fish buyer / difficulty is how many & how hard skillcheck is
    { item = 'salmon', label = 'Salmon', price = {500, 1000}, difficulty = {'medium', 'easy'} },
    { item = 'trout', label = 'Trout', price = {400, 800}, difficulty = {'easy', 'easy'} },
    { item = 'anchovy', label = 'Anchovy', price = {300, 550}, difficulty = {'easy'} },
}
