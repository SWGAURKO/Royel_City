...
QBShared.Jobs = {
	...
	police = {
		...
		grades = {
			...
			['1'] = { name = 'Constable', payment = 3600 },
			['2'] = { name = 'Nayek', payment = 3700 },
			['3'] = { name = 'ASI', payment = 3800 },
			['4'] = { name = 'Sergeant', payment = 3900 },
			['5'] = { name = 'SI', payment = 4000 },
			['6'] = { name = 'Inspector', payment = 4100 },
			['7'] = { name = 'ASP', payment = 4200 },
			['8'] = { name = 'SAP', payment = 4300 },
			['9'] = { name = 'SP', payment = 4400 },
			['10'] = { name = 'ADIG', isboss = true, payment = 4500 },
			['11'] = { name = 'DIG', isboss = true, payment = 4600 },
			['12'] = { name = 'AIG', isboss = true, payment = 4700 },
			['13'] = { name = 'IGP', isboss = true, payment = 4800 },
		},
