...
Lang["de"] = {
	confirm_buy_store: "Wollen Sie diesen Laden wirklich kaufen? <br> Preis: {0} ",
	please_select_category: "Bitte wählen Sie unten die erste Kategorie aus ",
	please_select_category_input: "Kategorie zum Kaufen auswählen",
	category_price: "kategorie Preis.",
	...
	filter_placeholder: "Produktname",

	confirmation_modal_fire_player: "Sind Sie sicher, dass Sie diesen Spieler entlassen möchten?",
	confirmation_modal_export_all: "Sind Sie sicher, dass Sie einen Auftrag starten möchten, um die maximale Menge dieses Produkts zu exportieren, die Ihr Lastwagen transportieren kann?",
	confirmation_modal_sell_category: "Sind Sie sicher, dass Sie diese Kategorie verkaufen möchten? Alle Produkte, die sich derzeit in dieser Kategorie auf Lager befinden, gehen verloren",

	navbar_main_page: "Ihr Geschäft",
	navbar_stock_page: "Produktbestand",
	...
	navbar_category_page: "Kategorien",
	...
	statistics_page_stock: "Lagerkapazität: {0}/{1}",
	statistics_page_stock_variety: "Lagervielfalt: {0}%",
	statistics_page_price_input: "Preis",
	statistics_page_price: "Verkaufspreis",
	statistics_page_export_price: "Exportpreis",
	statistics_page_stock_amount: "Lagerbestand",
	...
	statistics_page_stock_desc: "Hier können Sie alle Artikel anzeigen und mit ihnen interagieren, die in Ihrem Geschäft gespeichert sind. Überprüfen Sie Ihren aktuellen Lagerbestand, legen Sie Produktpreise fest oder exportieren Sie sie, um Einkommen zu generieren.",

	goods_page_title: "Waren kaufen",
	goods_page_desc: "Hier können Sie Waren über Importmissionen kaufen, um den Bestand Ihres Geschäfts aufzufüllen. Alternativ können Sie auch direkt Artikel aus Ihrem Inventar in den Lagerbestand des Geschäfts übertragen.",
	...
	categories_page_desc: "Verwenden Sie Ihr Geld, um neue Kategorien von Artikeln für Ihr Geschäft zu kaufen!",
	...
	bank_page_balance_text: "Ihr Kontostand ist:",

	bank_page_balance_table_title: "Erträge / Aufwendungen",
	bank_page_balance_title: "Titel",
	bank_page_balance_value: "Wert",
	bank_page_balance_date: "Datum",
	bank_page_hidden_balance: "Versteckte Bilanz anzeigen",
	bank_page_hide_balance: "Balance ausblenden",
	bank_page_show_balance: "Balance anzeigen",
	bank_page_load_balance: "Mehr laden...",

	bank_page_deposit_modal_title: "Geld einzahlen",
	bank_page_deposit_modal_desc: "Wie viel möchten Sie einzahlen?",
	...
	bank_page_modal_placeholder: "Menge",
	bank_page_modal_money_available: "Verfügbares Geld: {0}",
	bank_page_modal_cancel: "Abbrechen",

	category_page_buy_button: "Kategorie kaufen",
	category_page_sell_button: "Kategorie verkaufen",
	category_page_example_items: "Artikel, die mit der Kategorie geliefert werden",
	category_page_count_items: "Wird freigeschaltet: {0} Artikel",
