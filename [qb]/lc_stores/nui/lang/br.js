...
Lang["br"] = {
	confirm_buy_store: "Você realmente deseja comprar essa loja? <br> Preço: {0} ",
	please_select_category: "Por favor, selecione a categoria inicial abaixo ",
	please_select_category_input: "Selecione a categoria para comprar",
	category_price: "preço da categoria.",
	...
	filter_placeholder: "Nome",

	confirmation_modal_fire_player: "Tem certeza de que deseja demitir este jogador?",
	confirmation_modal_export_all: "Tem certeza de que deseja iniciar um trabalho para exportar a quantidade máxima deste produto que seu caminhão pode transportar?",
	confirmation_modal_sell_category: "Tem certeza de que deseja vender esta categoria? Todos os produtos atualmente em estoque nesta categoria serão perdidos",

	navbar_main_page: "Sua Loja",
	navbar_stock_page: "Estoque",
	...
	navbar_category_page: "Categorias",
	...
	statistics_page_stock: "Capacidade de Estoque: {0}/{1}",
	statistics_page_stock_variety: "Variedade do Estoque: {0}%",
	statistics_page_price_input: "Preço",
	statistics_page_price: "Preço de venda",
	statistics_page_export_price: "Preço para exportar",
	statistics_page_stock_amount: "Quantidade em estoque",
	...
	statistics_page_stock_desc: "Aqui, você pode visualizar e interagir com todos os itens armazenados na sua loja. Verifique o seu estoque atual, defina os preços dos produtos ou exporte-os para gerar renda",

	goods_page_title: "Comprar mercadorias",
	goods_page_desc: "Aqui, você pode comprar mercadorias por meio de missões de importação para repor o estoque da sua loja. Alternativamente, você também pode armazenar itens diretamente do seu inventário no estoque da loja",
	...
	categories_page_desc: "Use seu dinheiro para comprar novas categorias de items para a sua loja",
	...
	bank_page_desc: "Veja todo o seu fluxo de caixa aqui. Você pode depositar e sacar seu dinheiro",
	bank_page_withdraw: "Sacar dinheiro",
	bank_page_deposit: "Depositar dinheiro",
	bank_page_balance_text: "Seu saldo é:",

	bank_page_balance_table_title: "Receitas / Despesas",
	bank_page_balance_title: "Título",
	bank_page_balance_value: "Valor",
	bank_page_balance_date: "Data",
	bank_page_hidden_balance: "Mostrar Saldo Oculto",
	bank_page_hide_balance: "Ocultar saldo",
	bank_page_show_balance: "Mostrar saldo",
	bank_page_load_balance: "Carregue mais...",

	bank_page_deposit_modal_title: "Depositar dinheiro",
	bank_page_deposit_modal_desc: "Quanto você quer depositar?",
	bank_page_deposit_modal_submit: "Depositar dinheiro",

	bank_page_withdraw_modal_title: "Retirar dinheiro",
	bank_page_withdraw_modal_desc: "Quanto você quer sacar?",
	bank_page_withdraw_modal_submit: "Retirar dinheiro",

	bank_page_modal_placeholder: "Quantidade",
	bank_page_modal_money_available: "Dinheiro disponível: {0}",
	bank_page_modal_cancel: "Cancelar",

	category_page_buy_button: "Comprar categoria",
	category_page_sell_button: "Vender categoria",
	category_page_example_items: "Items que vem com a categoria",
	category_page_count_items: "Irá desbloquear: {0} produtos",
