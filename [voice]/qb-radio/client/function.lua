...
function Radio:connecttoradio(channel)
    ...
    TriggerServerEvent('qb-radio:server:addToRadioChannel', self.RadioChannel, self.userData[self.identifier].name)
    self:connectSound()
                ...
                options = {
                    {
                        ...
                        icon = 'fa-toggle-on',
                        onSelect = function ()
                            TriggerServerEvent('qb-radio:server:togglejammer', Radio.jammer[i].id)
                    ...
                    },
                    {
                        ...
                        onSelect = function ()
                            TriggerServerEvent('qb-radio:server:removejammer', Radio.jammer[i].id, isDamaged)
                        end
                    },
                    {
                        ...
                        onSelect = function ()
                            ...
                            TriggerServerEvent('qb-radio:server:changeJammerRange', Radio.jammer[i].id, input[1])
                            lib.showTextUI('[E] Configure Jammer')
                        end
                    },
                    {
                        ...
                        onSelect = function ()
                            ...
                            for j=1, #Radio.jammer[i].allowedChannels do
                                allowedChannels.options[#allowedChannels.options+1] = {
                                    ...
                                    onSelect = function ()
                                        ...
                                        TriggerServerEvent('qb-radio:server:removeallowedchannel', Radio.jammer[i].id, Radio.jammer[i].allowedChannels)
                                        lib.showTextUI('[E] Configure Jammer')
                                    end
                                }
                            end
                            allowedChannels.options[#allowedChannels.options+1] = {
                                ...
                                onSelect = function ()
                                    ...
                                    TriggerServerEvent('qb-radio:server:addallowedchannel', Radio.jammer[i].id, Radio.jammer[i].allowedChannels)
                                    lib.showTextUI('[E] Configure Jammer')
                                end
                            }
...
if Shared.Battery.state then
    CreateThread(function()
        while true do
            TriggerServerEvent('qb-radio:server:consumeBattery', Radio.batteryData)
