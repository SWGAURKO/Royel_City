RegisterCommand("police", function(source, args, rawCommand)
    ...
    Koci.Server:TriggerCallback("0r-chat:getCharacterInfo", source, {}, function(character)
        if character then
            if character.job.name == "police" then
                Koci.Server:TriggerCallback("0r-chat:sendJobMessages", source, {
                    job = "police",
                    message = {
                        type = "POLICE",
...
RegisterCommand("adminwhisper", function(source, args, rawCommand)
    ...
    if IsPlayerAceAllowed(source, "command") then
        Koci.Server:TriggerCallback("0r-chat:sendAdminMessages", source,
            {
                type = "ADMIN WHISPER",
...
RegisterCommand("announce", function(source, args, rawCommand)
    ...
    if IsPlayerAceAllowed(source, "command") then
        Koci.Server:TriggerCallback("0r-chat:sendAdminAnnounce", source,
            {
                type = "Announcement",
...
RegisterCommand("ooc", function(source, args, rawCommand)
    ...
    Koci.Server:TriggerCallback("0r-chat:sendMessages", source,
        {
            type = "OOC",
            ...
            sourceId = source,
            channel = "local",
            global = Config.OOCMessageGlobal,
        })
end)
...
RegisterCommand("showidentity", function(source, args, rawCommand)
    Koci.Server:TriggerCallback("0r-chat:getCharacterInfo", source, {}, function(character)
        if character then
            Koci.Server:TriggerCallback("0r-chat:showIdentity", source, {
                type = "CHARACTER INFO",
...
RegisterCommand("yellowpages", function(source, args, rawCommand)
    ...
    Koci.Server:TriggerCallback("0r-chat:sendYellowPages", source,
        {
            type = "YELLOW PAGES",
...
RegisterCommand("whisper", function(source, args, rawCommand)
    ...
    Koci.Server:TriggerCallback("0r-chat:sendWhisperMessage", source,
        {
            target = targetId,
            message = {
                type = "WHISPER",
...
RegisterCommand("playmusic", function(source, args, rawCommand)
    ...
    Koci.Server:TriggerCallback("0r-chat:playMusicWithUrl", source,
        {
            url = url,
        }
    )
...
RegisterCommand("stopmusic", function(source, args, rawCommand)
    Koci.Server:TriggerCallback("0r-chat:stopMusic", source)
end)

RegisterCommand("musicvolume", function(source, args, rawCommand)
    local volume = args[1]
    Koci.Server:TriggerCallback("0r-chat:setMusicVolume", source,
        {
...
RegisterCommand("clearall", function(source, args, rawCommand)
    if IsPlayerAceAllowed(source, "command") then
        ...
        print("All Chat cleared by " .. GetPlayerName(source))
    end
end)
