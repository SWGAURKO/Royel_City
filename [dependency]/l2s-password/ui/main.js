...
const SubmitData = () => {
    ...
    $.post(`https://l2s-password/dataPost`, JSON.stringify({data: returnData}))
}


const PostData = (data) => {
    return $.post(`https://l2s-password/dataPost`, JSON.stringify(data))
}
...
const CancelKeyboard = () => {
    ...
    $.post(`https://l2s-password/cancel`)
}
